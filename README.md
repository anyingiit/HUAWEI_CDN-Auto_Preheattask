...
Huawei cdn auto preheattask: no README or manifest to go on; based on its name, built with Python, this looks like a software project — open the repository to confirm.
...
```sh
HUAWEI_CDN-Auto_Preheattask --help
```
